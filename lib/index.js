...
module.exports = function loader(content) {
  ...
  var fileBaseName = path.basename(loaderContext.resourcePath, path.extname(loaderContext.resourcePath));
  ...
  return img.metadata().then(function (metadata) {
    ...
    loaderCallback(null, 'module.exports = {' + 'name: "' + fileBaseName + '", ' + 'srcSet:' + srcset + ',' + 'images:[' + images + '],' + 'src:' + firstImage.path + ',' + 'toString:function(){return ' + firstImage.path + '},' + 'placeholder: ' + placeholder + ',' + 'width:' + firstImage.width + ',' + 'height:' + firstImage.height + '};');
  }).catch(function (err) {
